...
public class Text 
{
    ...
    private int xPosition;           // The X coordinate of this Text
    private int yPosition;           // The Y coordinate of this Text
	...
	public Text(int diameter, int x, int y, String s, String col) {
        text = s;
        xPosition = x;
        yPosition = y;
        size = diameter;
