...
public class Ball 
{
    ...
    private int xPosition;           // The X coordinate of this Ball
    private int yPosition;           // The Y coordinate of this Ball
     ...
     *
     */
    public Ball(int x, int y, double diameter, String col)
    {
        xPosition = x;
        yPosition = y;
        size = diameter;
